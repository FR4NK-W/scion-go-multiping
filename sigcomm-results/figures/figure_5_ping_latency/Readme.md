...
To reconstruct this figure, following query need to be executed against our dataset and the results need to be stored into `new_scion_pings_per_hour.csv`.
...
Next, the following query need to be executed against our dataset and the results need to be stored into `new_ip_pings_per_hour.csv`.
...
Finally, the `plot_histogram.py` command needs to be executed to generate the plot under `sciera_hist_norm_cdf.pdf`.